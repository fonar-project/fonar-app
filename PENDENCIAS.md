...
O que ficou em aberto das US02 a US08, reunido num lugar só e organizado por
...
| "Melhorando" / "piorando" na tendência do AVQI e o limiar do que conta como mudança. | 01 | `l10n/app_strings.dart` |
...
| **Contrato do resultado** — `GET /analises/{id}`; hoje a tela mostra um resultado de exemplo, avisado como tal. | 07 | `analise/data/repositorio_analises_placeholder.dart` |
...
| Pendência | US | Onde |
|---|---|---|
| **Numeração das US03 a US08 foi deduzida** das telas do protótipo e do índice de ícones — conferir com o backlog. | 03–08 | — |
...
| Tela 02 do protótipo parece ser o **perfil do paciente** (com a situação do consentimento), ainda placeholder. | 02 | `pacientes/presentation/pages/paciente_detalhe_page.dart` |
